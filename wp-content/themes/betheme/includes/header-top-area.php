	...
	<div id="Action_bar">
		<div class="container">
			<div class="column one">
				...
				<?php echo '<p class="actionlog"><a href="' . esc_url( home_url( '/my-account/' ) ) . '">LOGIN</a></p>'; ?>
...
<div id="Top_bar" class="loading">
	...
	<div class="container">
		<div class="column one">
			<div class="topbtn">
			<div class="btn1"><a href="<?php echo esc_url( home_url( '/online/online-order.php' ) ); ?>">Order Online</a></div>
			<div class="btn2"><a href="<?php echo esc_url( home_url( '/reservation/' ) ); ?>">Book table</a></div>
			...
			<div class="toplang">
      <?php
      // Prevent raw shortcode text when WPML language switcher is unavailable.
					...
					<?php 
						if( ( mfn_header_style( true ) != 'header-overlay' ) && ( mfn_opts_get( 'menu-style' ) != 'hide' ) ){
							...
							echo '<a class="responsive-menu-toggle '. $mb_class .'" href="#">';
								if( $menu_text = trim( (string) mfn_opts_get( 'header-menu-text' ) ) ){
