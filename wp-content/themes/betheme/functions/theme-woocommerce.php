...
jQuery(document).ready(function () 
 {
    if (!!jQuery('.stheme1').offset()) 
	{
    var length = jQuery('.stheme').height() - jQuery('.scroll-right').height() + jQuery('.stheme1').offset().top;

    jQuery(window).scroll(function () {

        var scroll = jQuery(this).scrollTop();
        var height = jQuery('.stheme1').height() + 'px';

        if (scroll < jQuery('.stheme').offset().top) {
			...
			<div class="content_wrapper clearfix">
				...
				<?php 
					...
					if( is_search() ){
						...
						echo '<div id="lok" class="sidebar four columns stheme1">';
				...
				<!--.sections_group -->
				<div class="sections_group stheme">
					<div class="section">
