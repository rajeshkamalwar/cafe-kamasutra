							...
							foreach( $section['wraps'] as $wrap ){
								...
								if( key_exists( 'attr', $wrap ) ){
									...
									if( key_exists( 'move_up', $wrap['attr'] ) && $wrap['attr']['move_up'] ){
										...
										if( mfn_opts_get( 'builder-wrap-moveup' ) ){
											$data_mobile = 'data-mobile="no-move"';
										}
									}
								...
								echo '<div class="wrap mcb-wrap '. $wrap_class .' clearfix" style="'. $wrap_style .'" '. $parallax .' '. $data_mobile .'>';
