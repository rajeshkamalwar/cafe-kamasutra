...
<meta name="Copyright" content="<?php echo esc_attr( home_url( '/' ) ); ?>" />
<meta name="Author" content="<?php echo esc_attr( home_url( '/' ) ); ?>" />
...
<?php endif; ?>
<link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() . '/custom.css' ); ?>?ver=<?php echo esc_attr( wp_get_theme()->get( 'Version' ) ?: '1' ); ?>" type="text/css" media="all" />
