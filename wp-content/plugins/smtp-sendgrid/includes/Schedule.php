...
class Schedule {
	...
	private function doHooks() {
		...
		add_action( YAY_SMTP_SENDGRID_PREFIX . '_delete_email_log_schedule_hook', array( $this, 'delete_email_log_schedule' ) );

		if ( ! wp_next_scheduled( YAY_SMTP_SENDGRID_PREFIX . '_delete_email_log_schedule_hook' ) ) {
			$timeSch = YAY_SMTP_SENDGRID_PREFIX . '_specific_delete_time';
			wp_schedule_event( time(), $timeSch, YAY_SMTP_SENDGRID_PREFIX . '_delete_email_log_schedule_hook' );
		}
	}
