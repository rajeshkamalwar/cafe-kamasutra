...
<div class="form-group">
    ...
    if ($gift_action == "add") {
        ...
        $add_gift_query = "INSERT INTO `giftitem`(`gt_min_odr_amt`,`gt_max_odr_amt`,`gt_msg`,`gt_1`,`gt_2`,`gt_3`,`gt_4`,`gt_5`,`gt_6`) VALUES ('" . $add_min_odr_amunt . "','" . $add_max_odr_amunt . "','" . $add_msg . "','" . $add_gift1 . "','" . $add_gift2 . "','" . $add_gift3 . "','" . $add_gift4 . "','" . $add_gift5 . "','" . $add_gift6 . "')";
   ...
   <div class="form-group">
    ...
    if ($gift_action == "edit") {
        ...
        $edit_gift_query = "UPDATE `giftitem` SET `gt_min_odr_amt`='" . $edit_min_odr_amunt . "',`gt_max_odr_amt`='" . $edit_max_odr_amunt . "', `gt_msg`='" . $edit_msg . "',`gt_1`='" . $edit_gift1 . "',`gt_2`='" . $edit_gift2 . "',`gt_3`='" . $edit_gift3 . "',`gt_4`='" . $edit_gift4 . "',`gt_5`='" . $edit_gift5 . "',`gt_6`='" . $edit_gift6 . "' WHERE `gt_id`='" . $gift_id . "'";
