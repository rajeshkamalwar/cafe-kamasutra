                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="postcode_minimum_amt_new" name="postcode_minimum_amt_new" placeholder="For example: 12.00" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="attributes price">Delivery Charges</label>
                                            <input type="text" class="form-control" id="postcode_deliv_chrg_new" name="postcode_deliv_chrg_new" placeholder="For example: 2.00" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="attributes description">Free From</label>
                                            <input type="text" class="form-control" id="postcode_free_from_new" name="postcode_free_from_new" placeholder="For example: 22.00" required>
                                        </div>
            ...
            <script type="text/javascript">
                ...
                $(document).on('click', '#add_postcode', function () {
                    ...
                    if ($("#postcode_minimum_amt_new").val() == "") {
                        ...
                        return false;
                    }if ($("#postcode_deliv_chrg_new").val() == "") {
                        alert("Please provide delivery charges!");
                        $("#postcode_deliv_chrg_new").focus();
                        return false;
                    }if ($("#postcode_free_from_new").val() == "") {
                        alert("Please provide free delivery amount!");
                        $("#postcode_free_from_new").focus();
                        return false;
                    }
                ...
                $(document).on('click', '#update_rec', function () {
                    ...
                    if ($("#postcode_minimum_amt_edit").val() == "") {
                        ...
                        return false;
                    }if ($("#postcode_deliv_chrg_edit").val() == "") {
                        alert("Please provide delivery charges!");
                        $("#postcode_deliv_chrg_edit").focus();
                        return false;
                    }if ($("#postcode_free_from_edit").val() == "") {
                        alert("Please provide free delivery amount!");
                        $("#postcode_free_from_edit").focus();
                        return false;
                    }
                    ...
                    var postcode_deliv_chrg_edit = $("#postcode_deliv_chrg_edit").val();
                    var postcode_free_from_edit = $("#postcode_free_from_edit").val();
                    url = b_url + 'postcode_action.php';  //console.log(url);  console.log();
                    // console.log(url);
                    $.ajax({
                        type: "POST",
                        ...
                        data: {
                            ...
                            postcode_deliv_chrg_edit: postcode_deliv_chrg_edit,
                            postcode_free_from_edit: postcode_free_from_edit
                        },
                        dataType: "html",
                        success: function (data)
                        {
