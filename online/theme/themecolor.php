    ...
    <body class="hold-transition <?= theme_skin ?> sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="">Menu</li><li class="active">Theme Color</li>
                    </ol>
                </section>
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <div class="col-sm-12">
                                        <form name="timeset_form" id="timeset_form">
                                            ...
                                            <input type="text" class="form-control" id="themecolor" name="themecolor" placeholder="" required >
                                        </div>
                                        <div class="form-group">
                                            <label for="attributes h1color">heading color</label>
                                            <input type="text" class="form-control" id="h1color" name="h1color" placeholder="" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="pcolor">Paragraph color</label>
                                            <input type="text" class="form-control" id="pcolor" name="pcolor" placeholder="" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="menucolor">Menu Color</label>
                                            <input type="text" class="form-control" id="menucolor" name="menucolor" placeholder="" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="buttoncolor">Button Color</label>
                                            <input type="text" class="form-control" id="buttoncolor" name="buttoncolor" placeholder="" required>
                                        </div>
                                                </div>
            ...
            <script type="text/javascript">
                ...
                function load() {
                    url = b_url + 'themecolor_action.php';
                    var action = 'load';
                    $.ajax({
                        type: "POST",
                        url: url,
                ...
                $(document).on('click', '#set_minorder_update', function () {
                    ...
                    var action = 'update';
                    url = b_url + 'themecolor_action.php';  //console.log(url);  console.log();
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: {
