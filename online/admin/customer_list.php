        ...
        <div class="wrapper">
            ...
            <table class="table table-striped">
              ...
              <tbody>
               <?php
                ...
                $sql = "select *,promotion_tbl.id as user_ids, promotion_discount_code_tbl.expire_at,promotion_discount_code_tbl.created_at as coupon_created_at from promotion_tbl left join promotion_discount_code_tbl on promotion_tbl.id=promotion_discount_code_tbl.user_id order by promotion_tbl.id desc";
               ...
               ?>
                ...
                <tr>
                    ...
                    <td><a href="#" data-toggle="modal" data-target="#myModal-<?php echo $array['id'];?>"><?php echo $array['name'];?></a></td>
                    <td><?php echo $array['email'];?></td>
                    <td><?php echo $array['facebook_id'];?></td>
                    <td><?php 
                       if(empty($array['coupon_created_at'])){
                          echo "";
                       
                        }else{
                            echo date('d-m-Y',strtotime($array['coupon_created_at']));
                    ...
                    if(empty($array['expire_at'])){
                          echo "";
                       
                        }else{
                           echo date('d-m-Y',strtotime($array['expire_at']));
            ...
            <td> <?php 
                 ...
                 ?>
                    ...
                    <td><a title="View Details" class="btn btn-social-icon btn-primary" onclick="view_data(this,<?php echo $array['user_ids'];?>)" data-toggle="collapse" data-target="#demo-<?php echo $array['user_ids'];?>" class="accordion-toggle hendmouse" id="edit_record" dataid=""><i class="fa fa-eye"></i></a></td>
                     <td>

                     <?php if(!empty($array['coupon_code'])){ ?>

                     <button type="button" class="btn btn-info" onclick="reminder(this,<?php echo $array['user_ids'];?>)">Send mail</button>
                    <?php }?>
                     </td>

                     <td><button type="button" class="btn btn-danger" onclick="delete_pro(this,<?php echo $array['user_ids'];?>)">Delete</button></td>
                </tr>
...
<!-- //inner tabs// -->
          <tr class="detailstab">            
                <td colspan="9" class="hiddenRow">
                    <div class="accordian-body collapse" id="demo-<?php echo $array['user_ids'];?>">
                ...
                <!-- The Modal -->
  <div class="modal" id="myModal-<?php echo $array['id'];?>">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="close" onclick="close_model(this)" data-id="<?php echo $array['id'];?>" data-dismiss="modal">&times;</button>
        ...
        <input type="text" class="form-control" placeholder="Set discount" id="discount" name="discount" value="">
          <p style="text-align:center">Or</p>
        <input type="text" class="form-control" placeholder="Dish name" id="dish" name="dish" value="">
        <input type="hidden" class="form-control" name="id" value="<?php echo $array['user_ids'];?>">
        <input type="hidden" class="form-control" name="names" value="<?php echo $array['name'];?>">
        <input type="hidden" class="form-control" name="email" value="<?php echo $array['email'];?>">

      <?php 
    
      //create discount coupon code//

        $discount_coupon_code = substr(str_shuffle("0123456789ABCDEFJHIGKLMNOPQRSTUVWXYZ"), 0, 6);

      ?>

        <input type="hidden" class="form-control" name="code" value="<?php echo $discount_coupon_code; ?>">
        </div>
        
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" onclick="redeem_code(this,<?php echo $array['id'];?>)">Apply</button>
...
// alert($("#discount").val());
  ...
  var expire_time='<?php echo date('Y-m-d H:i:s', strtotime('+30 day', strtotime(date('Y-m-d H:i:s'))));?>';
