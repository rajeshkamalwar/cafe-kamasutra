        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="">Menu</li><li class="active">Minimum Order</li>
                    </ol>
                </section>
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <div class="col-sm-12">
                                        <form name="timeset_form" id="timeset_form">
                                            ...
                                            <input type="text" class="form-control" id="min_amt" name="min_amt" placeholder="For example: 12.00" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="attributes price">Delivery Charge</label>
                                            <input type="text" class="form-control" id="deli_chrg" name="deli_chrg" placeholder="For example: 2.00" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="attributes description">Free from</label>
                                            <input type="text" class="form-control" id="free_from" name="free_from" placeholder="For example: 22.00" required>
                                        </div>
                                                </div>
            ...
            <script type="text/javascript">
                ...
                $(document).on('click', '#set_minorder_update', function () {
                    ...
                    var deli_chrg=$('#deli_chrg').val();
                    var free_from=$('#free_from').val();
                    var action = 'update';
                    url = b_url + 'minorder_action.php';  //console.log(url);  console.log();
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: {
