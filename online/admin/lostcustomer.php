                                        ...
                                        <form name="timeset_form" >
                                            ...
                                            <div class="row">
												<div class="col-md-12 col-sm-12">
													<label>Lost Customers <br/>Select Customers who have not ordered for at least <input type="text" id="days" name="days"  placeholder="Enter Number of days"> days</label><br/>
												</div>
												 <div class="col-md-12 col-sm-12">
...
function clear() {
                   ...
                   function load() {
                    url = b_url + 'lostcustomer_action.php';
                    var action = 'load';
                    $.ajax({
                        type: "POST",
                        url: url,
      ...
      if(discount=='fixamount'){
		  ...
		  if ($("#percentageamt").val() == "") {
                    ...
                    url = b_url + 'lostcustomer_action.php';  //console.log(url);  console.log();
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: {
