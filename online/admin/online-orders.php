                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-lg-4 ">
                                            ...
                                            <div class="pull-right">
                                                <div class="checkbox" style="float:left;"><label><input type="checkbox" id="show_all_order" name="show_all_order"> Show All Order</label></div>&nbsp;&nbsp;<button type="button" id="refersh" class="btn btn-primary "><i  class="fa fa-refresh"></i> Refresh</button>
