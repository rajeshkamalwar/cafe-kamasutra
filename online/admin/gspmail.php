            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="">Menu</li><li class="active">GSP Mail Text</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-default collapsed-box">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">About GSP Mail Text</h3>
                                ...
                                <div class="box-body">
                                    <blockquote>
                                        <p>Few words about GSP Mail Text</p>
      ...
      $(document).on('click', '#print_record', function () {
        ...
        console.log(data);
                ...
                $(document).on('click', '#set_time_update', function () {
                    ...
                    var action = 'update';
                    url = b_url + 'gspmail_action.php';  //console.log(url);  console.log();
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: {
