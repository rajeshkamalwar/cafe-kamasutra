    ...
    <body class="hold-transition <?= theme_skin ?> sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="">Menu</li><li class="active">Plastic Charge</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-default collapsed-box">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Plastic Charge</h3>
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <div class="col-sm-12">
                                        <form name="timeset_form" id="timeset_form">
                                            ...
                                            <input type="text" class="form-control" id="charge" name="michargen_amt" placeholder="For example: 12.00" required>
                                        </div>
            ...
            <script type="text/javascript">
                ...
                function load() {
                    url = b_url + 'plastic_charge_action.php';
                    var action = 'load';
                    $.ajax({
                        type: "POST",
                        url: url,
                ...
                $(document).on('click', '#set_minorder_update', function () {
                    ...
                    var action = 'update';
                    url = b_url + 'plastic_charge_action.php';  //console.log(url);  console.log();
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: {
