...
$totlacatid = array();
 ...
 $list_cat_query = "Select `supcat_id`,`supcat_name_en` From `supercategories`";
$menu_order_query = "Select `sup_cat_order` from `supercategory_order` where `supcatorder_id`='1'";
...
//no cat found
    ...
    $final_query = '';
    if (!empty($finalstr)) {
        $final_query = "SELECT `supcat_id`,`supcat_name_en` FROM `supercategories` WHERE `supcat_id` IN (" . $finalstr . ") ORDER BY FIELD(`supcat_id`," . $finalstr . ")";
    }
            ...
            <script>
                ...
                $(document).ready(function () {
                    $('#save').click(function () {
                        ...
                        url = b_url + 'order_supcat_action.php';
