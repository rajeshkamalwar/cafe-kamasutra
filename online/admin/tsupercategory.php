    ...
    <body class="hold-transition <?= theme_skin ?> sidebar-mini">
        <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <div class="row"> 
                                        <div class="col-lg-8">
                                            <h3 class="box-title">Available Super Categories</h3>
                                        </div>
                                        <div class="col-lg-4 ">
                        ...
                        <div class="modal-content"><!-- modal-content -->
                            <form method="post"> 
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Add New Super Category</h4>
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="row"> 
                                               <div class="col-md-6 col-sm-12">
                                                <input type="text" class="form-control" id="supcat_name_new_ln1" name="supcategory_name_new_ln1" placeholder="Super Category name in  <?= lang1;?>" required >
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <input type="text" class="form-control" id="supcat_name_new_ln2" name="supcategory_name_new_ln2" placeholder="Super Category name in <?= lang2;?>"  >
                                            </div>
                                        </div>
                                        </div>
                                        <div class="form-group">
                                           ...
                                           <div class="row"> 
                                               <div class="col-md-6 col-sm-12">
                                                   <textarea class="form-control" rows="3" id="supcat_description_add_ln1" name="supcategory_description_add_ln1"   placeholder="Super Category description in  <?= lang1;?>">&nbsp;&nbsp;</textarea>
                                               </div>
                                               <div class="col-md-6 col-sm-12">
                                                   <textarea class="form-control" rows="3" id="supcat_description_add_ln2" name="supcategory_description_add_ln2"  placeholder="Super Category description in  <?= lang2;?>">&nbsp;&nbsp;</textarea>
                                               </div>
                                           </div>
                                        </div>
                    ...
                    <div class="modal-dialog"><!-- modal-dialog -->
                        <div class="modal-content"><!-- modal-content -->
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">View Super Category Details</h4>
                            </div>
                            <div class="modal-body">
                    ...
                    <div class="modal-dialog"><!-- modal-dialog -->
                        <div class="modal-content"><!-- modal-content -->
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">Edit Super Category's Details</h4>
                                <form role="form">
                            </div>
                            <div class="modal-body">
                                <p id="edit_notimsg"></p>
                    ...
                    <div class="modal-dialog"><!-- modal-dialog -->
                        <div class="modal-content"><!-- modal-content -->
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">Change Super Category's Status</h4>
                                <form method="post" >
                            </div>
                            <div class="modal-body">
            ...
            <script type="text/javascript">
             function load() {
                    url = b_url + 'tsupercategories_action.php';
                    var cat_action = 'load';
                    $.ajax({
                        type: "POST",
                        url: url,
                ...
                $(document).on('click', '#add_cat_form', function () {
                    ...
                    if ($("#supcat_name_new_ln1").val() == "") {
                        alert("Please provide category name!");
                        $("#supcat_name_new_ln1").focus();
                        return false;
                    }
                    
                    if ($("#supcat_description_add_ln1").val() == "") {
                        alert("Please provide category description!");
                        $("#supcat_description_add_ln1").focus();
                        return false;
                    }
                    
                    

                    url = b_url + 'tsupercategories_action.php';  //console.log(url);  console.log();
                    var cat_action = 'add';
                    var supcat_name_new_ln1 = $('#supcat_name_new_ln1').val();
                    var supcat_name_new_ln2 = $('#supcat_name_new_ln2').val();
                    var supcat_description_add_ln1 = $('#supcat_description_add_ln1').val();
                    var supcat_description_add_ln2 = $('#supcat_description_add_ln2').val();
                    //alert(supcat_description_add_ln2);
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            supcat_name_new_ln1: supcat_name_new_ln1,
                            supcat_name_new_ln2: supcat_name_new_ln2,
                            supcat_description_add_ln1: supcat_description_add_ln1,
                            supcat_description_add_ln2: supcat_description_add_ln2
                        },
                        dataType: "html",
                        success: function (data)
                        {//   console.log(data);
                ...
                $(document).on('click','#view_record',function(){
                    var supcat_id = $(this).attr("dataid");
                    var cat_action = 'view';
                    url = b_url + 'tsupercategories_action.php';
                ...
                $(document).on('click', '#update_rec', function () {
                    ...
                    if ($("#supcat_name_edit_ln1").val() == "") {
                        alert("Please provide category name!");
                        $("#supcat_name_edit_ln1").focus();
                        return false;
                    }
                    if ($("#supcategory_description_edit_ln1").val() == "") {
                        $("#supcategory_description_edit_ln1").val(" ");
                    }
                    

                    url = b_url + 'tsupercategories_action.php';
                    var cat_action = 'edit';
                    var supcat_id = $('#categories_id').val();
                    var supcat_name_edit_ln1 = $('#supcat_name_edit_ln1').val();
                    var supcat_name_edit_ln2 = $('#supcat_name_edit_ln2').val();
                    var supcat_description_edit_ln1 = $('#supcat_description_edit_ln1').val();
                    var supcat_description_edit_ln2 = $('#supcat_description_edit_ln2').val();
                    ...
                    $.ajax({
                        ...
                        data: {
                            cat_action: cat_action,
                            supcat_id: supcat_id,
                            supcat_name_edit_ln1: supcat_name_edit_ln1,
                            supcat_name_edit_ln2: supcat_name_edit_ln2,
                            supcat_description_edit_ln1: supcat_description_edit_ln1,
                            supcat_description_edit_ln2: supcat_description_edit_ln2
                ...
                $(document).on('click', '#change_status_btn', function () {
                 ...
                 $(document).on('click', '#delete_record', function () {
                    var supcat_id = $(this).attr("dataid");   //console.log(id);
                    $("#dele_hidden").val(supcat_id);
                });
                $(document).on('click', '#del_rec', function () {
                    var supcat_id = $("#dele_hidden").val(); //console.log(id);
