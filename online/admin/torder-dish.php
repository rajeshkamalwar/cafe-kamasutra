...
$menu_order_query = "Select `cat_sort_order` from `table_category_order` where `cat_sortorder_id`='1'";
...
//no cat found
    ...
    while ($row = $result_cat_query->fetch_assoc()) {
       ...
       $AllCatAvilable.='<div class="col-md-3 col-sm-12"><a href="'.base_url.'torder-dish-indi.php?cat_id='.$row['cat_id'].'"><button type="button" class="btn btn-primary  btn-block margin">'.$row['cat_name_en'].'</button></a></div>';
