    ...
    <body class="hold-transition <?= theme_skin ?> sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="">Menu</li><li class="active">Discount Discription</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-default collapsed-box">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">About Discount Description</h3>
            ...
            <script type="text/javascript">
                ...
                function load() {
                    url = b_url + 'discount_description_action.php';
                    var action = 'load';
                    $.ajax({
                        type: "POST",
                        url: url,
        ...
        console.log(data);
                ...
                $(document).on('click', '#set_time_update', function () {
                    ...
                    var action = 'update';
                    url = b_url + 'discount_description_action.php';  //console.log(url);  console.log();
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: {
