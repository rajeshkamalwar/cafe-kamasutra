...
a.bk_to_top i.fa-arrow-up {
    ...
    <body id="toprk" class="hold-transition <?= theme_skin ?> sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="modal fade" id="modal-add">
                    <div class="modal-dialog"><!-- modal-dialog -->
                        <div class="modal-content"><!-- modal-content -->
                            <form id="form" action="tajaxupload.php" method="post" enctype="multipart/form-data">
                ...
                <div class="modal fade" id="modal-edit">
                    <div class="modal-dialog"><!-- modal-dialog -->
                        <div class="modal-content"><!-- modal-content -->
                             <form id="formedit" action="tajaxeditupload.php" method="post" enctype="multipart/form-data">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span></button>
...
<div class="modal modal-danger fade" id="modal-imagedlt">
			...
			<a class="bk_to_top" href="#toprk"><i class="fa-arrow-up"></i></a>
