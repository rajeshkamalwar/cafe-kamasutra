        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <!-- Attributes action --><?php include 'tattributes_actions.php';                              ?><!-- Attributes action -->
                        <!-- About section -->
                        <div class="col-xs-12">
            ...
            <script type="text/javascript">
                ...
                function load() {
                    url = b_url + 'tattributes_actions.php';
                ...
                $(document).on('click', '#add_attrib_form', function () {
                    ...
                    url = b_url + 'tattributes_actions.php';  //console.log(url);  console.log();
